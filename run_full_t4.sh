...
python muse_perf.py --batch_size 4 --full --device cuda --file full_$GPU.txt --compiled None
python muse_perf.py --batch_size 4 --full --device cuda --file full_$GPU.txt --compiled default
python muse_perf.py --batch_size 4 --full --device cuda --file full_$GPU.txt --compiled reduce-overhead --model muse_f16
...
python muse_perf.py --batch_size 32 --full --device cuda --file full_$GPU.txt --model muse_f16
