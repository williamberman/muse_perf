...
python muse_perf.py --batch_size 8 --component backbone --device cuda --file backbone_$GPU.txt
...
python muse_perf.py --batch_size 16 --component backbone --device cuda --file backbone_$GPU.txt --compiled reduce-overhead --model sd
